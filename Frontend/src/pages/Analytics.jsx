...
export default function Analytics() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-algo-950 p-4 md:p-6 lg:p-8 max-w-6xl mx-auto flex items-center justify-center">
  ...
  const chartData = [
    ...
    { name: 'Hard', count: stats?.hardProblems || 0, fill: '#ef4444' },
  ]

  const statCards = [
    { icon: CheckCircle2, label: 'Completion Rate', value: `${completionRate}%`, color: 'text-purple-glow' },
    ...
    { icon: Timer, label: 'Total Time Spent', value: timeSpent ? `${timeSpent}m` : '0m', color: 'text-danger' },
  ]

  return (
    <div className="min-h-screen bg-algo-950 p-4 md:p-6 lg:p-8 max-w-6xl mx-auto">
      {/* Header */}
      <div className="mb-6">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                ...
                <Tooltip
                  ...
                  contentStyle={{ backgroundColor: '#15101f', borderColor: 'rgba(255,255,255,0.06)', borderRadius: '8px', color: '#fff' }}
                />
